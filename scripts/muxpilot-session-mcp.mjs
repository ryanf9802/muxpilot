...
function toolDefinitions() {
  ...
  return [
    ...
    { name: "read_session", description: "Read a bounded recent transcript tail from a muxpilot session.", inputSchema: object({ sessionId, limit: { type: "integer", minimum: 1, maximum: 30 } }, ["sessionId"]) },
