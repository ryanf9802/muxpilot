...
Shadow mode runs a second muxpilot lane for app-server burn-in while production remains live. Start it from a dedicated checkout or Git worktree of the branch under test:
